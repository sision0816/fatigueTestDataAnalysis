...
for cycle in range (1, maxCycle-1):
   if cycle in df['Zyklus'].values:
    ...
    #==============================================================================
       ...
       fittingLength_tensile = 20 #set the minimum fitting length
       fittingStartPoint_tensile = maxStrainCount + 2#start fitting from the  maxStrainCount + 10
       fittingEndPoint_tensile = maxStrainCount + 25 #define the ftting end point at maxStrainCount+50, fitting range definition
...
#               print eModulus_tensile
    ...
    #==============================================================================
       ...
       fittingStartPoint_compressive = minStrainCount + 2#start fitting from the  maxStrainCount + 10
       fittingEndPoint_compressive = minStrainCount + 25 #define the ftting end point at maxStrainCount+50, fitting range definition
...
#           print count
           try:
               loop['Strain'][count]/((loop['Stress MPa'][count]-interceptAve_tensile)/(eModulusAve_tensile*1000))
           except TypeError:
