...
readFile_timeSequence = 'Nr37_experiment_timeData.csv' # in with csv format and in list
...
readFile_firstCycle = 'Nr37_cycle1_1kN.csv' 
...
#==============================================================================
#    Incase they upper or lower array is empty can lead to IndexError
#==============================================================================
   except IndexError:
       energy_upperRight_simps = None
       energy_upperLeft_simps = None
       energy_totalCyclicStrain_simps = None
       energy_nonplasticStrain_simps = None
       energy_plasticStrain_simps = None
       energy_upperRight_trapz = None
       energy_upperLeft_trapz = None
       energy_totalCyclicStrain_trapz = None # total cyclic strain energy
       energy_nonplasticStrain_trapz = None#the integration would be negative value, should get absolute value for area
       energy_plasticStrain_trapz = None
#==============================================================================
...
#==============================================================================
   try:
       ...
       shapeParameter_simps = None
       shapeParemeter_trapz = None
   ...
   try:
      ...
      dfOutput.loc[len(dfOutput)] = None
#==============================================================================
